...
[['text' => "- ADEL | @rzrzr", 'url' => "https://t.me/rzrzr"]],
[['text' => "-𝒎𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍'", 'url' => "https://t.me/rzrzr"]],
]]) 
]);
}
...
'chat_id'=>$chat_id2,
'message_id'=>$message_id,
'text' => "𝒘𝒆𝒍𝒄𝒐𝒎𝒆 , \n𝒊𝒏 𝒕𝒉𝒆 𝒄𝒉𝒆𝒄𝒌𝒆𝒓 𝒖𝒔𝒆𝒓 𝒏𝒂𝒎𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 \n𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 - ADEL | @rzrzr 🇪🇬 @rzrzr . ",
'reply_markup' => json_encode(['inline_keyboard' => [
[['text'=>"-- ADEL | @rzrzr 🇪🇬'", 'url' => "https://t.me/rzrzr"],['text'=>"-𝒎𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍'", 'url' => "https://t.me/rzrzr"]],
]]) 
]);
unlink('mode');
}
...
'text'=>"⌁ Data Checker Band , king @rzrzr 🐊",
'reply_markup'=>json_encode(['inline_keyboard'=>[
...
bot('sendMessage',['chat_id'=>$chat_id2,'message_id'=>$message_id,
'text'=>"⌁ Data Checker bot , king @rzrzr 🐊",
'reply_markup'=>json_encode(['inline_keyboard'=>[
